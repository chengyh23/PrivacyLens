...
DATA_PATH=data_pipeline_MA/predictions/Mistral-7B-Instruct-v0.2-branch_4-pref_pairs_${ROLE}.train.json
...
ACCELERATE_LOG_LEVEL=info accelerate launch --gpu_ids 3 --config_file accelerate_configs/deepspeed_zero3_cpu.yaml --mixed_precision bf16 \
    --num_processes 1 \
    train.py \
    --do_train \
    --eval_strategy 'steps' \
