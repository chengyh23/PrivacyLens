...
CUDA_VISIBLE_DEVICES=2 python evaluation/get_final_action.py --input-path $DATASET_PATH --output-path $PRED_PATH"0.csv" --model $MODEL --prompt-type $PROMPT_TYPE --start-index 0 --num -1 &
